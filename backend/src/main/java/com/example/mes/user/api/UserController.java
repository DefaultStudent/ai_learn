...
public class UserController {
    ...
    @PostMapping @ResponseStatus(HttpStatus.CREATED) @PreAuthorize("hasAnyRole('SYSTEM_ADMIN', 'ADMIN')")
    ...
    @PutMapping("/{id}") @PreAuthorize("hasAnyRole('SYSTEM_ADMIN', 'ADMIN')")
    ...
    /** @param id 用户主键 */
    @DeleteMapping("/{id}") @ResponseStatus(HttpStatus.NO_CONTENT) @PreAuthorize("hasAnyRole('SYSTEM_ADMIN', 'ADMIN')")
